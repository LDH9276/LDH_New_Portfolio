    ...
    <div className={`relative w-full h-full flex items-center
      ...
      <div className="section-container py-12 md:py-20">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          {/* Right: Profile */}
          <div className="w-full max-w-[280px] sm:max-w-[350px] lg:max-w-none lg:w-5/12 relative aspect-[3/4] lg:aspect-[4/5] overflow-hidden bg-lime/20 dark:bg-lime/10">
            <Image
              src="/images/profile02-2.png"
              alt="프로필"
              fill
              className="object-cover lg:object-cover scale-105 group-hover:scale-110 transition-transform duration-700  group-hover:mix-blend-normal"
            />
          </div>
        </div>
      </div>
